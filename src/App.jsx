...
import LoginForm from './Components/Login/LoginForm'; // Adjust the path as necessary
...
import Dash5cal from "./Components/Dashboard/Dash5cal";
            ...
            <TransitionGroup>
              ...
              >
                  ...
                  <Routes>
                    ...
                    <Route path="/Configr" element={<><Configuration2/><LeftNavbar /></>} />
                    ...
                    <Route path="/Dashh5" element={<Dash5cal />} />
                    ...
                    <Route path="/Dashh6" element={<Dash6 />} />
                    ...
                    <Route path="/Dmort" element={<Dashboardmort />} />
                       ...
                       <Route path="/Dashcol" element={<Dashcol />}/>
