...
// const AdmissionsDischargesByDate = () => {
//   const [selectedDate, setSelectedDate] = useState(new Date());
//   const [data, setData] = useState([]);

//   const fetchAdmissionsDischarges = async () => {
//     const selectedMonth = selectedDate.getMonth() + 1; // Months are zero-based
//     const selectedYear = selectedDate.getFullYear();

//     try {
//       const response = await axios.get(`/admdis?month=${selectedMonth}&year=${selectedYear}`);
//       setData(response.data);
//     } catch (error) {
//       console.error('Error fetching admissions and discharges data:', error);
//     }
//   };

//   const handleDateChange = (date) => {
//     setSelectedDate(date);
//     fetchAdmissionsDischarges();
//   };
...
//         showMonthYearPicker
//       />
//       <h2>Admissions and Discharges for {selectedDate.toLocaleString('default', { month: 'long', year: 'numeric' })}</h2>
//       <table>
//         <thead>
//           <tr>
//             <th>Date</th>
...
//         </thead>
//         <tbody>
//           {data.map(({ date, admissions, discharges }) => (
//             <tr key={date}>
//               <td>{date}</td>
//               <td>{admissions}</td>
//               <td>{discharges}</td>
...
// export default AdmissionsDischargesByDate;
